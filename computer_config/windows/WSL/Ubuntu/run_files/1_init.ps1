...
Copy-item -Path $(Join-Path -Path $scriptPath_init -ChildPath "..\..\general\wsl\config\wsl.conf") -Destination "\\wsl$\$($general_defaults.main_distro)$($general_defaults.tmp_directory)\wsl.conf"
