...
Copy-item -Path $(Join-Path -Path $scriptPath_init -ChildPath "..\..\general\\wsl\disable_sudo_pass.sh") -Destination "\\wsl$\Ubuntu\$tmp_setup_path\disable_sudo_pass.sh"
...
wsl -d Ubuntu rm -Rf $tmp_setup_path
