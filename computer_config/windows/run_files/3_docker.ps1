...
wsl -d $($general_defaults.docker_distro) bash "$($general_defaults.tmp_directory)/user_docker_init.sh" "$($general_defaults.docker_sock)" "$($general_defaults.docker_host_sock)" "$($general_defaults.tiki_docker_desktop)" "$($general_defaults.docker_dir)"
